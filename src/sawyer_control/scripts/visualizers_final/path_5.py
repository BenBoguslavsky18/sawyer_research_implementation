...
# Usage: Replace the spline generation line with:
# self.spline_controlpoints, self.spline_waypoints, self.display_waypoints = self.ik_motion.generate_maze_path(start_pose, end_pose)
